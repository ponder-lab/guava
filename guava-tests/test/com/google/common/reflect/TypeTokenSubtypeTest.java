...
import com.google.common.reflect.TypeTokenSubtypeTest.MyTypeBoundUsesImplicitBound;
import com.google.common.reflect.TypeTokenSubtypeTest.UseList;
import com.google.common.reflect.TypeTokenSubtypeTest.UseSerializableIterable;
...
public class TypeTokenSubtypeTest extends TestCase {
  ...
  private static class WildcardSubtypingTests extends SubtypeTester {
    ...
    wildcardBoundUsesImplicitlyRecursiveBoundedWildcard(
      ...
      return (UseList<? extends List<Enum<? extends Enum<?>>>>) isSubtype(arg);
    }
  ...
  public interface UseSerializableIterable<T extends Serializable & Iterable<?>> {}

  public interface UseList<T extends List<?>> {}

  private enum MyEnum {}

  public interface MyTypeBoundUsesImplicitBound<E extends Enum<?>> {}
}
